...
<body>
    <nav class="navbar navbar-expand-md navbar-light bg-transparent shadow-sm" style="background: rgba(0, 0, 0, 0.3) !important;">
        <div class="container">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="background: rgba(0, 0, 0, 0.8);">
                                <a class="dropdown-item" href="{{ route('logout') }}" style="color: white !important;"
