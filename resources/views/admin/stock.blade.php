...
@section('content')
    <style>
        ...
        .filter-bar .btn-add-product:hover,
        .filter-bar .btn-add-product:focus {
            background: linear-gradient(90deg, #36b3f6 0%, #0d6efd 100%);
            color: #fff;
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <tr class="table-success">
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#detail1">Detay</button>
                        ...
                        <tr class="table-warning">
                            ...
                            <td>Depo B</td>
                            <td><span class="badge bg-warning"><i class="fas fa-exclamation-triangle"></i> Az Stok</span>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-info" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#detail2">Detay</button>
                                <button class="btn btn-sm btn-warning">Düzenle</button>
                                <button class="btn btn-sm btn-danger">Sil</button>
                            </td>
                        </tr>
                        ...
                        <tr class="table-danger">
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#detail3">Detay</button>
                                <button class="btn btn-sm btn-warning">Düzenle</button>
                                <button class="btn btn-sm btn-danger">Sil</button>
                            </td>
                        </tr>
