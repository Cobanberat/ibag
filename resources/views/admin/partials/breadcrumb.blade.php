...
<div class="row g-3 mb-4 align-items-center">
    <div class="col-lg-8 d-flex align-items-center gap-3 flex-wrap">
        ...
        <div class="dropdown position-relative">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#"><i class="fa fa-bug text-danger me-2"></i> Yeni arıza
                        bildirimi</a></li>
                <li><a class="dropdown-item" href="#"><i class="fa fa-user-plus text-success me-2"></i> Yeni
    ...
    <div class="col-lg-4 d-flex justify-content-end align-items-center gap-3">
        <div class="input-group shadow-sm" style="width:280px;">
            <input type="text" class="form-control form-control-sm py-2" placeholder="Panelde ara...">
            <button class="btn btn-outline-secondary btn-sm"><i class="fa fa-search"></i></button>
        </div>
        <button class="btn btn-outline-info btn-sm shadow-sm py-2" data-bs-toggle="tooltip" data-bs-placement="left"
            title="Yardım almak için tıkla!"><i class="fa fa-question-circle"></i></button>
        <div class="card border-0 shadow-sm mb-0" style="min-width:120px;">
            <div class="card-body py-2 px-3 d-flex align-items-center gap-2">
                <img src="https://ui-avatars.com/api/?name=Admin&background=6366f1&color=fff&rounded=true"
